                ...
                <?php 
                    ...
                    <style>
                        ...
                        .masthead {
                            ...
                            background-image: url('assets/CraneBanner5.jpg'); 
                    ...
                    <div class="col-lg-3">
                     <div class="card menu-item ">
                        ...
                        <div class="card-body">
                          <p class="card-title"><?php echo "Name: "."<b>". $row['name']."</b>"; ?></p>
                          <p class="card-text truncate"><?php echo "Descriptions: "."<b>" .$row['description']."</b>"; ?></p>
                          <p class="card-text truncate"><?php echo "Price (Ush): -"."<b>" .number_format($row['price'],0)."/-"."</b>"; ?></p>
